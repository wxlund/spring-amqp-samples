...
public class EmitLogHeader {
	...
	public static void main(String[] argv) throws Exception {
		if (argv.length < 1) {
			...
			System.err.println("Providing defaults of test-message queue1 temperature hot color white");
			argv = "test-message queue1 x-match temperature hot color white".split(" ");
		}
